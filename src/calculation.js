...
export default {
    abs: makeFunc(processingProxy, "abs", [{ value: [int_, float_] }]),

    ceil: makeFunc(processingProxy, "ceil", [{ value: [int_, float_] }]),
    ...
    exp: makeFunc(processingProxy, "exp", [{ value: [int_, float_] }]),

    floor: makeFunc(processingProxy, "floor", [{ value: [int_, float_] }]),
    ...
    round: makeFunc(processingProxy, "round", [{ value: [int_, float_] }]),

    sq: makeFunc(processingProxy, "sq", [{ value: [int_, float_] }]),

    sqrt: makeFunc(processingProxy, "sq", [{ value: [int_, float_] }])
};
