...
import { processingProxy, makeFunc, optional, constructOptionalContectManager, self, cachedLazy, ignored } from "./utils.js";
...
export default {
    ...
    beginClosedShape: cachedLazy(constructOptionalContectManager, [{
        ...
        __enter__: makeFunc(self => self, "__enter__" [ self ]),
        __exit__: makeFunc(() => processingProxy.endShape(constants.CLOSE), "__exit__", [
            self,
            { "exc_type": object, ignored },
            { "exc_value": object, ignored },
            { "traceback": object, ignored }
