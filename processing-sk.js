...
function main(name) {
    ...
    mod.blendColor = new Sk.builtin.func(function (c1, c2, mode) {
        ...
        var c = Sk.misceval.callsim(mod.color, new Sk.builtin.int_(0), new Sk.builtin.int_(0), new Sk.builtin.int_(0));
    ...
    mod.camera = new Sk.builtin.func(function (eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ) {
        // camera()
        // camera(eyeX, eyeY, eyeZ,centerX, centerY, centerZ,upX, upY, upZ)
        if (typeof eyeX === "undefined") {
            mod.processing.camera();
        } else {
            mod.processing.camera(eyeX.v, eyeY.v, eyeZ.v, centerX.v, centerY.v, centerZ.v, upX.v, upY.v, upZ.v);
        }
    });
    ...
    mod.curve = new Sk.builtin.func(function (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) {
        ...
        if (typeof v9 === "undefined") {
            ...
            mod.processing.curve(v1.v, v2.v, v3.v, v4.v, v5.v, v6.v, v7.v, v8.v, v9.v, v10.v, v11.v);
        } else {
            mod.processing.curve(v1.v, v2.v, v3.v, v4.v, v5.v, v6.v, v7.v, v8.v, v9.v, v10.v, v11.v, v12.v);
        }
    });
    ...
    mod.loadShape = new Sk.builtin.func(function (filename) {
        // loadShape(filename)
        // returns shape
        var shape = Sk.misceval.callsim(mod.PShapeSVG, new Sk.builtin.str("string"), filename);
        return shape;
    });
    ...
    mod.get = new Sk.builtin.func(function (x, y) {
        ...
        return Sk.misceval.callsim(mod.color, new Sk.builtin.int_(mod.processing.red(clr)), new Sk.builtin.int_(mod.processing.green(clr)), new Sk.builtin.int_(mod.processing.blue(clr)));
    });
